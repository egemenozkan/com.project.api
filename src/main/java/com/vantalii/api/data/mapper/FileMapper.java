...
//			@Result(property = "user.lastName", column = "last_name"),
	...
	@Results(value = {@Result(property = "status", column = "status", javaType = com.project.api.data.enums.Status.class, typeHandler = com.vantalii.api.data.mapper.handler.StatusTypeHandler.class),
			@Result(property = "pageType", column = "page_type", javaType = com.project.api.data.enums.LandingPageType.class, typeHandler = com.vantalii.api.data.mapper.handler.LandingPageTypeTypeHandler.class),
			@Result(property = "user.id", column = "user_id")})
