...
public interface PlaceMapper {
	...
	@Results(value = {@Result(property = "type", column = "type", javaType = com.project.api.data.enums.PlaceType.class, typeHandler = com.vantalii.api.data.mapper.handler.PlaceTypeTypeHandler.class),
...
//	@Options(flushCache = Options.FlushCachePolicy.TRUE)
	...
	@Results(value = {@Result(property = "type", column = "type", javaType = com.project.api.data.enums.PlaceType.class, typeHandler = com.vantalii.data.mybatis.typehandler.PlaceTypeTypeHandler.class),
			@Result(property = "language", column = "language", javaType = com.project.common.enums.Language.class, typeHandler = com.vantalii.data.mybatis.typehandler.LanguageTypeHandler.class)})
...
//			@Result(property = "language", column = "language", javaType = com.vantalii.enums.Language.class, typeHandler = com.vantalii.api.data.mapper.handler.LanguageTypeHandler.class)})
	...
	@Results(value = {@Result(property = "status", column = "status", javaType = com.project.api.data.enums.Status.class, typeHandler = com.vantalii.api.data.mapper.handler.StatusTypeHandler.class),
