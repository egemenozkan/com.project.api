...
import com.vantalii.data.service.IDatapoolService;
...
public class DatapoolRestController {
	...
	public ResponseEntity<List<Nationality>> getNationalities() {
		...
		ResponseEntity<List<Nationality>> response = new ResponseEntity<List<Nationality>>(nationalities,
				HttpStatus.OK);
	...
	public ResponseEntity<List<DestinationAutocomplete>> getDestinations(@RequestParam String query) {
		...
		ResponseEntity<List<DestinationAutocomplete>> response = new ResponseEntity<List<DestinationAutocomplete>>(
				destinations, HttpStatus.OK);
