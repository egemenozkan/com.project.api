...
//    
//search?type=place&fields=name,checkins,picture,location,phone,website,category_list,about&q=avm, turkey    
//	@Test
...
//        System.out.println("access token: " + restTemplate.get);
        ...
        try {
            testObject = restTemplate.getForObject(AUTH_SERVER_URL + "/search?type=place&fields=name,checkins,picture&q=crystal", Object.class);
